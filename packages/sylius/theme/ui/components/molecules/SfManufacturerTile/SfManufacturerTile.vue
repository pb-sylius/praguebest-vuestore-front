...
export default {
  ...
  mounted() {
    ...
    Object.keys(this.$refs).forEach(el => {
      console.log(this.$refs[el].$el)
      console.log(this.$refs[el].$el.clientHeight)
      console.log(this.$refs[el].$el.clientWidth)
    })
    */
  },
  props: {
...
<style lang="scss">
@import "./SfManufacturerTile.scss";
</style>
