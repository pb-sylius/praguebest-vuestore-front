...
<script>
import SfGallery from "../../molecules/SfGallery/SfGallery.vue";
import SfHeading from "../../atoms/SfHeading/SfHeading.vue";
import SfPrice from "../../atoms/SfPrice/SfPrice.vue";
import SfRating from "../../atoms/SfRating/SfRating.vue";
import SfIcon from "../../atoms/SfIcon/SfIcon.vue";
import SfTabs from "../../organisms/SfTabs/SfTabs.vue";
...
import SfNotification from "../../molecules/SfNotification/SfNotification.vue";
import productAImg from "../../../assets/img/productA.png";
import productBImg from "../../../assets/img/productB.jpg";
  ...
  data() {
    return {
      ...
      product: {
        ...
        images: [
          {
            mobile: { url: productAImg},
            desktop: { url: productAImg},
            big: { url: productAImg},
            alt: "Product A",
          },
          {
            mobile: { url: productBImg },
            desktop: { url: productBImg },
            big: { url: productBImg },
            alt: "Product B",
          },
          {
