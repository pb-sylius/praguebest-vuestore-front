...
export var getIframeRoot = function getIframeRoot() {
...
export var categoryMatcher = function categoryMatcher(matchCatgories, propKey) {
...
export var tableArgsBuilder = function tableArgsBuilder(properties, propsConfig, hiddenProps, matchCategory) {
  return _toConsumableArray(sortByKey(properties, 'key')).reduce(function (acc, prop) {
    ...
    var initialValues = storage.getLocalStorage(ADDON_ID).initialValues;
    acc[prop.name] = {
      category: '',
